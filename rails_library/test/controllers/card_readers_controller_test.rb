...
class CardReadersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create card_reader" do
    assert_difference("CardReader.count") do
      post card_readers_url, params: { card_reader: { date_taking_book: @card_reader.date_taking_book, name_book: @card_reader.name_book, name_library: @card_reader.name_library } }
    end
  ...
  test "should update card_reader" do
    patch card_reader_url(@card_reader), params: { card_reader: { date_taking_book: @card_reader.date_taking_book, name_book: @card_reader.name_book, name_library: @card_reader.name_library } }
